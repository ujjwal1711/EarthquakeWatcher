...
import earthquake.com.earthquakeapplication.app.earthquakewatcher.UI.CustomInfoWindow;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener ,GoogleMap.OnMarkerClickListener{
    ...
    private void getEarthQuakes() {
        ...
        JsonObjectRequest jsonobjectrequest = new JsonObjectRequest(Request.Method.GET, Constants.URL, new  com.android.volley.Response.Listener<JSONObject>() {
            @Override
